...
### [Admissions Data Engineering Pipeline](https://github.com/tomcrojo/admissions-ml-api)
Databricks and PySpark medallion pipeline producing ML-ready features from raw admissions data.
- Scope: 120K+ profiles processed through Bronze, Silver, and Gold layers
- Stack: PySpark, Databricks, Delta Lake, FastAPI, Docker

### [Security Log Analytics](https://github.com/tomcrojo/security-log-analytics)
Automated ETL and reporting pipeline for monthly security monitoring and stakeholder reporting.
- Impact: ~12 hours/month eliminated, 6.3x ETL speedup with Polars vs Pandas
- Stack: Python, Polars, PostgreSQL, Jinja2, GitHub Actions
